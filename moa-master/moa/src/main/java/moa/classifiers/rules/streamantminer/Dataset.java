...
import static moa.classifiers.rules.streamantminer.Attribute.Type.CONTINUOUS;
import static moa.classifiers.rules.streamantminer.Attribute.Type.NOMINAL;

import static moa.classifiers.rules.streamantminer.Config.CONFIG;

import  moa.classifiers.rules.streamantminer.sAntMinerClassifier;
...
public class Dataset {
	...
	if (candidates.size() > 1) {
		...
		majority =
			candidates.get(CONFIG.get(sAntMinerClassifier.RANDOM_GENERATOR)
