...
public class RuleClassification extends AbstractMOAObject{
    ...
    protected DoubleVector attributesProbability = new DoubleVector(); // Probability of each attribute.
 ...
 // Statistics used for normalise actualClass and predictedClass.
