...
//        
//        for (int i = 0; i < learners.length; i++) {
//          learners[i].getDescription(sb, 0);
//        }
//        System.out.println(sb.toString());
    ...
    public Measurement[] getEvaluationMeasurements(Measurement[] modelMeasurements, LearningPerformanceEvaluator[] subEvaluators, Learner[] subLeaners) {
        ...
        if ((subEvaluators != null) && (subEvaluators.length > 0)) {
            ...
            for (Learner sublearner : subLeaners) {
                if (sublearner != null) {
                    subMeasurements.add(sublearner.getModelMeasurements());
                }
